package com.ecommerce.product_service.advices;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<?>> handleProductSkuAlreadyExistsException(ProductSkuAlreadyExistsException ex) {
        ApiError apiError = ApiError.builder()
                .message(ex.getLocalizedMessage())
